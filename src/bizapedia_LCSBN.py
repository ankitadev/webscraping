...
for ite in myNameArray:
    ...
    #print not really necessary, just for testing purpose
    ...
    with open('COUNT_Delaware_BIzapedia.csv', 'a') as csvfile:
    ...
    for item in tree.iter('{https://www.bizapedia.com/}Company'):
        ...
        with open('Delaware_California_BIzapedia.csv', 'a') as csvfile:
            writer = csv.writer(csvfile, quoting=csv.QUOTE_ALL)
